...
setTimeout(function() { 
    jQuery( "body.elementor-panel-loading #elementor-panel-state-loading" ).prepend( "<div class='theplus-bk-ele-spinner-main'>Still loading? <br/><a href='https://theplusaddons.com/docs/fix-elementor-editor-stuck-on-loading-screen/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=links' target='_blank' class='theplus-bk-ele-spinner-info'>Check Solutions</a></div>" );
}, 60000);
