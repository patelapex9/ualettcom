...
function theplus_carousel_list(data_widget=''){	
	...
	$('.list-carousel-slick').each(function() {
			...
			var tablet_slider_dots_style=$self.data("tablet_slider_dots_style");
			var mobile_slider_dots_style=$self.data("mobile_slider_dots_style");
			
			var slider_arrows=$self.data("slider_arrows");
			var slider_arrows_style=$self.data("slider_arrows_style");
			var tablet_slider_arrows_style=$self.data("tablet_slider_arrows_style");
			var mobile_slider_arrows_style=$self.data("mobile_slider_arrows_style");
			var arrows_position=$self.data("arrows_position");
			var tablet_arrows_position=$self.data("tablet_arrows_position");
			var mobile_arrows_position=$self.data("mobile_arrows_position");
			...
			// Tablet
			if(responsive_Device === 'tablet'){
				if(tablet_slider_arrows_style=='style-1'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+tablet_slider_arrows_style+'">Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+tablet_slider_arrows_style+'">Next</button>';
				}
				if(tablet_slider_arrows_style=='style-2'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+tablet_slider_arrows_style+'"><span class="icon-wrap"></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+tablet_slider_arrows_style+'"><span class="icon-wrap"></span>Next</button>';
				}
				if(tablet_slider_arrows_style=='style-3' || tablet_slider_arrows_style=='style-4' ){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+tablet_slider_arrows_style+' '+tablet_arrows_position+'">Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+tablet_slider_arrows_style+' '+tablet_arrows_position+'">Next</button>';
				}
				if(tablet_slider_arrows_style=='style-5'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+tablet_slider_arrows_style+'"><span class="icon-wrap"></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+tablet_slider_arrows_style+'"><span class="icon-wrap"></span>Next</button>';
				}
				if(tablet_slider_arrows_style=='style-6'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+tablet_slider_arrows_style+'"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+tablet_slider_arrows_style+'"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i></span>Next</button>';
				}
			}

			// Mobile
			if(responsive_Device === 'mobile'){
				if(mobile_slider_arrows_style=='style-1'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+mobile_slider_arrows_style+'">Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+mobile_slider_arrows_style+'">Next</button>';
				}
				if(mobile_slider_arrows_style=='style-2'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+mobile_slider_arrows_style+'"><span class="icon-wrap"></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+mobile_slider_arrows_style+'"><span class="icon-wrap"></span>Next</button>';
				}
				if(mobile_slider_arrows_style=='style-3' || mobile_slider_arrows_style=='style-4' ){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+mobile_slider_arrows_style+' '+mobile_arrows_position+'">Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+mobile_slider_arrows_style+' '+mobile_arrows_position+'">Next</button>';
				}
				if(mobile_slider_arrows_style=='style-5'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+mobile_slider_arrows_style+'"><span class="icon-wrap"></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+mobile_slider_arrows_style+'"><span class="icon-wrap"></span>Next</button>';
				}
				if(mobile_slider_arrows_style=='style-6'){
					prev_arrow='<button role="tab" type="button" class="slick-nav slick-prev '+mobile_slider_arrows_style+'"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-left" aria-hidden="true"></i></span>Previous</button>';
					next_arrow='<button role="tab" type="button" class="slick-nav slick-next '+mobile_slider_arrows_style+'"><span class="icon-wrap"><i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i></span>Next</button>';
				}
			}
				...
				responsive: [
					{
						...
						settings: {
                            ...
                            dotsClass:tablet_slider_dots_style,
					...
					},
					{
						...
						settings: {
                            ...
                            dotsClass:mobile_slider_dots_style,
						}
					}
				]
			}
