		...
		if ( ! empty( $custom_url ) ) {
			...
			<?php } else { ?>
				<a href="<?php echo esc_url( $custom_url ); ?>"  
									...
									echo $nofollow;
									?>
				><?php include THEPLUS_INCLUDES_URL . 'gallery/format-image.php'; ?></a>
			<?php } ?>			
			<?php
			...
			<?php } else { ?>
				<a href="<?php echo esc_url( $full_image ); ?>" <?php echo $popup_attr_icon1; ?>><?php include THEPLUS_INCLUDES_URL . 'gallery/format-image.php'; ?></a>
				<?php
			}
		} else {
