<?php
	...
	/** Product Countdown Fields*/
	if( isset( $megamenu ) && ! empty( $megamenu ) && ! empty( $check_category['theplus_woo_countdown_switch'] ) ) {		
		require_once THEPLUS_INCLUDES_URL.'plus-options/custom-metabox/custom_field_woo_product_countdown.php';
	}
