...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="product-list-content">
		...
		<?php if ( $layout != 'metro' ) { ?>
			...
			?>
				<div class="product-quick-view"><a href="<?php echo esc_url( get_the_permalink() ); ?>" class="quick-view-btn"><i class="fas fa-eye" aria-hidden="true"></i></a></div>
			</div>
		<?php } ?>
		...
		<div class="post-content-bottom">
			...
			<?php require THEPLUS_INCLUDES_URL . 'product/post-meta-title.php'; ?>
			...
			?>
				<?php if ( ! empty( $display_cart_button ) && $display_cart_button == 'yes' && $product->is_in_stock() ) { ?>
		...
		if ( $layout == 'metro' ) {
			...
			<?php
				...
				require THEPLUS_INCLUDES_URL . 'dynamic-listing/blog-skeleton.php';
		?>
	</div>
</article>
