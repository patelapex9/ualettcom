...
class Theplus_Section_Column_Link extends Elementor\Widget_Base {
	...
	public function tp_section_column_link($element) {		
		...
		$element->add_control(
			'sc_link_switch',
			[
				'label' => wp_kses_post( "'Wrapper Link <a class='tp-docs-link' href='" . esc_url($this->TpDoc) . "make-elementor-container-clickable/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>", 'theplus' ),
