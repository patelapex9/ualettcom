...
function theplus_senitize_js_input( $input ) {
...
function theplus_get_style_list( $max=4, $none='',$custom='' ) {
	$options=array();
...
function theplus_messy_columns($columns='',$layout='',$class_css='',$desktop='',$tablet='',$mobile='',$desktop_column='',$tablet_column='',$mobile_column=''){
	$css_messy=$d_column=$t_column=$m_column=$d_nth_child='';
 ...
 * @since 5.5.6
 */
function theplus_dashboard_url($slug){
