...
$gsap_attr       = '';
$gsapClass       = '';
if ( ! empty( $settings['magic_scroll'] ) && 'yes' === $settings['magic_scroll'] ) {
...
if ( ! empty( $gsapScroll ) || ( isset( $settings['magic_scroll'] ) && 'yes' === $settings['magic_scroll'] ) || ( isset( $settings['plus_tooltip'] ) && 'yes' === $settings['plus_tooltip'] ) || ( isset( $settings['plus_mouse_move_parallax'] ) && 'yes' === $settings['plus_mouse_move_parallax'] ) || ( isset( $settings['plus_tilt_parallax'] ) && $settings['plus_tilt_parallax'] == 'yes' ) || ( isset( $settings['plus_overlay_effect'] ) && 'yes' === $settings['plus_overlay_effect'] ) || ( isset( $settings['plus_continuous_animation'] ) && 'yes' === $settings['plus_continuous_animation'] ) ) {

	$after_content .= '</div>';
	$after_content .= '</div>';

	if ( isset( $settings['plus_mouse_move_parallax'] ) && 'yes' === $settings['plus_mouse_move_parallax'] ) {
		$after_content .= '</div>';
	}

	if ( isset( $settings['plus_tilt_parallax'] ) && 'yes' === $settings['plus_tilt_parallax'] ) {
		$after_content .= '</div>';
	}

	$inline_tippy_js = '';
	if ( isset( $settings['plus_tooltip'] ) && 'yes' === $settings['plus_tooltip'] ) {
