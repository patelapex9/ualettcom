...
class ThePlus_Everest_form extends Widget_Base {
	...
	public function get_custom_help_url() {
		$doc_url = $this->tp_doc . 'customize-everest-forms-in-elementor';
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'none',
				'options' => $this->theplus_get_everest_form_post(),
			)
		);
	...
	/**
	 * Get theplus_get_everest_form_post.
	 *
	 * @since 1.0.0
	 * @version 5.4.2
	 */
	public function theplus_get_everest_form_post() {
		$EverestForm = array();
		...
		if ( ! empty( $ev_form ) ) {
			...
			$EverestForm['none'] = esc_html__( 'No everest forms found', 'theplus' );
		}
