...
class ThePlus_Horizontal_Scroll_Advance extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'scroll_effects',
			array(
				'label'   => wp_kses_post( "Slide Scroll Effects <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "add-page-transition-effect-in-elementor-horizontal-scroll/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => array(
		...
		$this->add_control(
			'bg_transition',
			array(
				'label'     => wp_kses_post( "Background Transition <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "change-background-image-on-horizontal-page-scroll-in-elementor/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
		...
		$repeater->add_control(
			'bg_color',
			array(
				'label'     => wp_kses_post( "Color <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "change-background-colour-on-horizontal-page-scroll-in-elementor/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
		...
		$this->add_control(
			'fixBgtitle',
			array(
				'label'     => wp_kses_post( "Sticky Section <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "make-a-section-sticky-on-scroll-in-elementor-horizontal-page-scroll/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'On', 'theplus' ),
				'label_off' => esc_html__( 'Off', 'theplus' ),
				'default'   => '',
		...
		$this->add_control(
			'section_id',
			array(
				'label'       => wp_kses_post( "Section ID <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "add-dots-navigation-in-elementor-horizontal-page-scroll/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
		...
		$this->add_control(
			'URLParameter',
			array(
				'label'        => wp_kses_post( "URL Parameter <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "link-to-a-specific-section-in-elementor-horizontal-page-scroll/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'On', 'theplus' ),
				'label_off'    => esc_html__( 'Off', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'       => wp_kses_post( "Unique Connection ID <a class='tp-docs-link' href='" . esc_url( $this->tp_doc ) . "add-next-previous-button-in-elementor-horizontal-page-scroll/?utm_source=wpbackend&utm_medium=elementoreditor&utm_campaign=widget' target='_blank' rel='noopener noreferrer'> <i class='eicon-help-o'></i> </a>" ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'description' => esc_html__(
