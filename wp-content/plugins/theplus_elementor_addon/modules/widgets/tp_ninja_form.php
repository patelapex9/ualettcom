...
class ThePlus_Ninja_form extends Widget_Base {
	...
	public function get_custom_help_url() {
		$doc_url = $this->tp_doc . 'customize-ninja-forms-in-elementor';
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => '0',
				'options' => $this->theplus_get_ninja_form_post(),
			)
		);
		$this->add_control(
			'form_style',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .theplus-ninja-form.style-1 label,.theplus-ninja-form.style-1 .nf-form-layout .nf-field-label label,{{WRAPPER}} .theplus-ninja-form.style-1 .nf-error-msg,.theplus-ninja-form.style-1 .ninja-forms-req-symbol,{{WRAPPER}} .theplus-ninja-form.style-1 span' => 'color: {{VALUE}};',
				),
			)
		);
	...
	public function render() {
		...
		$this->add_render_attribute( 'contact-form', 'class', array( 'theplus-contact-form', 'theplus-ninja-form' ) );
		$this->add_render_attribute( 'contact-form', 'id', array( 'theplus-ninja-form-' . get_the_ID() ) );
	 ...
	 * @version 5.4.2
	 */
	public function theplus_get_ninja_form_post() {
		$options = array();
