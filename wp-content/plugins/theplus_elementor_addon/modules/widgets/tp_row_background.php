	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition'  => array(
					'select_anim'    => array( 'bg_gradientcolor' ),
					'gradient_style' => array( 'linear' ),
				),
				'of_type'    => 'gradient',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition'  => array(
					'select_anim'               => array( 'bg_image' ),
					'columns_parallax_style'    => 'columns_simple_image',
					'image_parallax_style'      => array( 'style_1', 'style_2' ),
					'column_bg_image_new[url]!' => '',
				),
			)
		);
		...
		$this->start_controls_tabs(
			'tabs_responsive_image',
			array(
				'condition' => array(
					'select_anim'      => array( 'bg_image' ),
					'responsive_image' => array( 'yes' ),
				),
			)
		);
		$this->start_controls_tab(
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'select_anim' => array( 'bg_color', 'bg_animate_gradient', 'scroll_animate_color' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition'  => array(
					'select_anim' => array( 'bg_animate_gradient' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'select_anim' => array( 'scroll_animate_color' ),
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'select_anim' => array( 'scroll_animate_color', 'bg_animate_gradient' ),
				),
			)
		);
		$this->add_control(
		...
		$this->start_controls_tabs(
			'tabs_responsive_video',
			array(
				'condition' => array(
					'select_anim'         => array( 'bg_video' ),
					'responsive_bg_video' => array( 'yes' ),
				),
			)
		);
		$this->start_controls_tab(
		...
		$this->start_controls_tabs(
			'tabs_responsive_video_mp4',
			array(
				'condition' => array(
					'select_anim'          => array( 'bg_video' ),
					'responsive_video_mp4' => array( 'yes' ),
				),
			)
		);
		$this->start_controls_tab(
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'select_anim' => array( 'bg_Image_pieces' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition'  => array(
					'select_anim'       => array( 'bg_Image_pieces' ),
					'bg_options'        => array( 'bg_gradient' ),
					'bg_gradient_style' => array( 'linear' ),
				),
				'of_type'    => 'gradient',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'middle_style' => array( 'canvas' ),
					'canvas_style' => array( 'style_2', 'style_3', 'style_4', 'style_5', 'style_6', 'style_7' ),
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'middle_style' => array( 'canvas' ),
					'canvas_style' => array( 'style_3', 'style_4', 'style_7' ),
				),
			)
		);
		/*
		...
		$repeater_multi_layered->start_controls_tabs(
			'tabs_magic_scroll',
			array(
				'condition' => array(
					'magic_scroll' => array( 'yes' ),
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'middle_style' => array( 'multi_layered_parallax' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'middle_style' => array( 'mordern_parallax' ),
				),
			)
		);
		/*
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'middle_style' => array( 'moving_image' ),
				),
			)
		);
		/*
		...
		$repeater_effects->start_controls_tabs(
			'tabs_magic_scroll',
			array(
				'condition' => array(
					'magic_scroll' => array( 'yes' ),
		...
		$this->add_control(
			...
			array(
				...
				'condition'   => array(
					'middle_style' => array( 'mordern_image_effect' ),
				),
			)
		);
		/*Modern Image Effect*/
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '',
				'condition' => array(
					'overlay_style' => array( 'normal_color' ),
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'of_type'   => 'gradient',
				'condition' => array(
					'overlay_style' => array( 'gradient_color' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition'  => array(
					'overlay_style'             => array( 'gradient_color' ),
					'overlay_bg_gradient_style' => array( 'linear' ),
				),
				'of_type'    => 'gradient',
			)
		);
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'overlay_style'             => array( 'gradient_color' ),
					'overlay_bg_gradient_style' => array( 'radial' ),
				),
				'of_type'   => 'gradient',
			)
		);
		$this->add_control(
			...
			array(
				...
				'dynamic'   => array( 'active' => true ),
				'condition' => array(
					'overlay_style' => array( 'texture_image' ),
				),
			)
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( isset( $select_anim ) && ! empty( $select_anim ) && $select_anim == 'bg_gradientcolor' ) {
			if ( ! empty( $settings['gradient_color1'] ) && ! empty( $settings['gradient_color2'] ) ) {
				...
				} elseif ( ! empty( $settings['gradient_style'] ) && $settings['gradient_style'] == 'radial' ) {
				...
				if ( $settings['columns_video_variant'] == 'youtube' && ! empty( $settings['columns_youtube_video_id'] ) ) {
					...
					if ( ! empty( $settings['responsive_video_mp4'] ) && $settings['responsive_video_mp4'] == 'yes' && $detect->isTablet() ) {
						...
						$output      .= '<div class="pt-plus-bg-video pt-plus-columns-bg-wrap columns-video-bg self-hosted-video-bg ' . esc_attr( $video_responsive_poster ) . '" id="wrapper-' . esc_attr( $uniqid2 ) . '" style="background-image: url(' . esc_js( $poster_url ) . ');" ' . esc_attr( $responsive_video_image ) . '>';
							$output  .= '<video id="' . esc_attr( $uniqid2 ) . '" class="self-hosted-videos video-js vjs-default-skin columns_vc_hidden-md columns_vc_hidden-sm columns_vc_hidden-xs"  data-autoplay autoplay preload="auto" width="100%" height="100%"  autoplay="true" playsinline ' . $video_atts2 . ' data-setup="{}" ' . $data_attr_video . '></video>';
						$output      .= '</div>';
					} elseif ( ! empty( $settings['responsive_video_mp4'] ) && $settings['responsive_video_mp4'] == 'yes' && $detect->isMobile() ) {
						$video_atts2 .= 'poster="' . esc_url( $poster_url ) . '" loop="true" muted="true"';
						$output      .= '<div class="pt-plus-bg-video pt-plus-columns-bg-wrap columns-video-bg self-hosted-video-bg ' . esc_attr( $video_responsive_poster ) . '" id="wrapper-' . esc_attr( $uniqid2 ) . '" style="background-image: url(' . esc_js( $poster_url ) . ');" ' . esc_attr( $responsive_video_image ) . '>';
							$output  .= '<video id="' . esc_attr( $uniqid2 ) . '" class="self-hosted-videos video-js vjs-default-skin columns_vc_hidden-md columns_vc_hidden-sm columns_vc_hidden-xs"  data-autoplay autoplay preload="auto" width="100%" height="100%"  autoplay="true" playsinline ' . $video_atts2 . ' data-setup="{}" ' . $data_attr_video . '></video>';
						$output      .= '</div>';
		...
		if ( $select_anim == 'bg_Image_pieces' ) {
			...
			} elseif ( ! empty( $settings['bg_options'] ) && $settings['bg_options'] == 'bg_color' ) {
				if ( ! empty( $settings['bg_pieces_color'] ) ) {
					$bg_style .= 'background:' . esc_attr( $settings['bg_pieces_color'] ) . ';';
				}
			} elseif ( ! empty( $settings['bg_options'] ) && $settings['bg_options'] == 'bg_gradient' ) {
				...
				foreach ( $settings['multi_layered_images'] as $item ) {
					...
					if ( isset( $item['layer_image']['url'] ) && $item['layer_image']['url'] != '' ) {
						...
						$output     .= '<div class="theplus_multi_layered_parallax ' . esc_attr( $uimg_id ) . ' ' . esc_attr( $visiblity_hide ) . ' ' . esc_attr( $magic_class ) . '" >';
							$output .= '<div class="multi_layered_parallax ' . esc_attr( $parallax_scroll ) . '" style="background:url(' . esc_url( $image_src ) . ');' . $layer_bg_image . ';' . $mordern_z_index . '" ' . $magic_attr . '>';
						$output     .= '</div>';
						$output     .= '</div>';
					}
					++$ij;
		...
		if ( ! empty( $settings['overlay_style'] ) && $settings['overlay_style'] == 'gradient_color' ) {
			...
			} elseif ( ! empty( $settings['overlay_bg_gradient_style'] ) && $settings['overlay_bg_gradient_style'] == 'radial' ) {
