...
$cfg['blowfish_secret']					= 'Pxt(8Tm#z@U(yvt@f{JW8bZn4:?L&DJ=' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_9CKGDa0wRYmsNhLSidZBH3n/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://ualett.asesores.com.do/wp-admin/?rand=92426161&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://ualett.asesores.com.do/wp-admin/?rand=51233812&pma_logout=1';
